    ...
    <section>
        <div className=" md:mx-28 mx-10 mt-40">
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-20 ">
               ...
               <h2 className=' text-[45px] font-bold text-[#181818] '>There have some easy steps to join with us!</h2>
               ...
               <ul>
                <li className=' relative flex justify-start gap-5 py-10 after:content-[""] after:bg-[#D8D8D8] after:absolute after:w-full after:border after:top-0 after:-left-0'>
                    <div>
