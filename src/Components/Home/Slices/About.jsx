  ...
  return (
    <section>
        ...
        <div className=' max-w-[480px]'>
          ...
          <p className='text-[45px] font-bold text-[#181818]'>About our Consuting Agency Team</p>
          <p className='font-bold	text-lg	text-[rgb(24,24,24)]'>We create experiences and build products that make business grow</p>
          <p className='text-base font-normal text-[#595566]'>Get help from Alex Moore, a professional business coach with advanced experience on growth and business scaling.</p>
