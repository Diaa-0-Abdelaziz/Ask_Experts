...
export default function Main() {
  return (
    <section className='relative bg-red-700 bg-[url("./imgs/Photo.png")] bg-cover h-screen'>
      {/* <img src={photo} alt="" className=' w-full'/> */}
      <div className="container top-2/4 left-2/4 -translate-x-1/2 -translate-y-1/2 absolute ">
      <article className='bg-[#FFFFFFD9] py-[50px] px-[58px] mt-24 max-w-xl	 rounded-special'>
        <h3 className='md:text-[50px] text-[25px] font-bold text-[#181818] mb-2'>Your small business growth advisors</h3>
